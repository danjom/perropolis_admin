    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand_type', models.IntegerField(choices=[('Food/Snacks', 'Food/Snacks'), ('Drugs', 'Drugs'), ('Accesories/Toys', 'Accesories/Toys')], verbose_name='Brand Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('life_expectancy', models.DecimalField(decimal_places=1, max_digits=3, validators=[django.core.validators.MaxValueValidator(30), django.core.validators.MinValueValidator(1)], verbose_name='Life Expectancy')),
                ('size', models.IntegerField(choices=[('Tea cup', 'Tea cup'), ('Small', 'Small'), ('Medium', 'Medium'), ('Large', 'Large'), ('GIANT', 'GIANT')])),
                ('health_score', models.DecimalField(decimal_places=1, max_digits=3, validators=[django.core.validators.MaxValueValidator(99), django.core.validators.MinValueValidator(0)], verbose_name='Healt Score')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=30, unique=True, verbose_name='Name')),
                ('taxes_percentage', models.DecimalField(decimal_places=2, max_digits=4, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(0)], verbose_name='Taxes Percentage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30, verbose_name='Name')),
                ('drug_type', models.IntegerField(choices=[('pills', 'Pills'), ('inyection', 'Inyection'), ('syrup', 'Syrup'), ('suppository', 'Suppository')], verbose_name='Drug Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('speciality', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core_data.medicalspeciality')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['name'], name='ix_speciality_name'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['vet_id', 'speciality_id'], name='ix_speciality_vet'),
        ),
